...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    title: "About Invoice.wiki - Free Invoice Generator",
    description: "Learn about our free online invoice generator for freelancers and businesses.",
        ...
        <div className="container px-4 md:px-6 py-8 md:py-12">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-foreground mb-8">
              ...
              <Link href="/create-invoice" className="text-primary underline hover:no-underline">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
              ...
              <ul className="space-y-2 text-blue-700 dark:text-blue-300">
                <li>
                  <strong>🧮 Flexible Tax Support:</strong> Choose your tax system or hide taxes completely. Works for
                  any country.
                </li>
                <li>
                  <strong>🔄 Reverse Charge:</strong> EU B2B invoicing with automatic reverse charge disclaimer.
                </li>
                <li>
                  <strong>👁️ Hide Tax Option:</strong> Create clean invoices without tax columns when not needed.
                </li>
                <li>
                  <strong>🎨 10 Colors:</strong> Match your brand with custom accent colors.
                </li>
                <li>
                  <strong>🌍 6 Languages:</strong> EN, DE, CS, PL, SK, UK — serve international clients.
                </li>
              </ul>
            </div>
            ...
            <p className="mb-6">
              ...
              information stays entirely on your device, processed locally in your browser for maximum data security.
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>Company Name –</strong> Official business name.
              </li>
              <li>
                <strong>Business Address –</strong> Registered address of the seller.
              </li>
              <li>
                <strong>Company ID –</strong> Official registration number.
              </li>
              <li>
                <strong>Tax ID –</strong> Tax identification number (if applicable).
              </li>
              <li>
                <strong>Contact Details –</strong> Email, phone number, and website.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>Client Name –</strong> Name of the person or business being billed.
              </li>
              <li>
                <strong>Client Address –</strong> Delivery or legal address.
              </li>
              <li>
                <strong>Company ID & Tax ID –</strong> Registration and tax info of the buyer.
              </li>
              <li>
                <strong>Contact –</strong> Client’s email or phone number.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>Invoice Number –</strong> Unique identifier for tracking.
              </li>
              <li>
                <strong>Issue & Due Dates –</strong> When invoice was created and when payment is due.
              </li>
              <li>
                <strong>Currency –</strong> Used for the transaction.
              </li>
              <li>
                <strong>Reference –</strong> Optional PO or order numbers.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>Accepted Methods –</strong> Bank transfer, card, PayPal, cash, etc.
              </li>
              <li>
                <strong>Bank Details –</strong> Account number, IBAN, BIC/SWIFT.
              </li>
              <li>
                <strong>Status –</strong> Paid or unpaid label.
              </li>
            </ul>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>
                <strong>Service/Product –</strong> Name of what was sold.
              </li>
              <li>
                <strong>Quantity & Unit Price –</strong> Per-item breakdown.
              </li>
              <li>
                <strong>Tax Rate –</strong> Percentage applied (if applicable).
              </li>
              <li>
                <strong>Total –</strong> Final amount including tax.
              </li>
            </ul>
            ...
            <p className="mb-6">
              Invoices are official commercial records used for tax reporting, financial accounting, and legal
              protection. Requirements vary by country — always verify local regulations.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div>
                ...
                <p className="text-muted-foreground">
                  USD, EUR, GBP, PLN, CZK, UAH, and many more with proper formatting.
                </p>
              </div>
              <div>
            ...
            <ul className="list-disc pl-6 space-y-2 mb-8">
              <li>
                <strong>Free forever –</strong> No subscriptions, no trials, no fees.
              </li>
              <li>
                <strong>Instant PDF invoices –</strong> Ready-to-download professional documents.
              </li>
              <li>
                <strong>Browser-based –</strong> Use on any device without installing anything.
              </li>
              <li>
                <strong>No login –</strong> Start creating invoices immediately.
              </li>
              <li>
                <strong>Multi-currency & tax support –</strong> Ideal for international invoicing.
              </li>
              <li>
                <strong>Secure & private –</strong> Your data never leaves your browser.
              </li>
            </ul>
            ...
            <p className="mb-6">
              Our invoice generator creates clean, professional documents that reflect well on your business. Here's an
              example of what your invoices will look like:
            </p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 p-6 rounded-lg mb-8">
              ...
              <p className="mb-4">Free forever. No signup. Takes 2 minutes. PDF download included.</p>
              <Link
                href="/create-invoice"
