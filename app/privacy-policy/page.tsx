...
export const metadata: Metadata = {
  ...
  description:
    "Invoice.wiki privacy policy. We don't collect personal data - all processing happens in your browser. No tracking, no data storage, complete privacy protection.",
  ...
  twitter: {
    ...
    title: "Privacy Policy - Invoice.wiki",
    description: "Learn about Invoice.wiki's privacy-first approach to online invoice generation.",
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6 text-foreground">
              ...
              <p className="mb-4 leading-relaxed">
                ...
                free invoice generator does not collect personal data. All invoice creation and PDF generation happens
                within your web browser. Professional invoices are created on your device, and all invoice data is
                cleared when you close your browser.
              </p>
              <p className="mb-4 leading-relaxed">
                We do not use cookies for tracking or advertising. The only data we store in your browser is theme
                preferences (light/dark) in localStorage to provide a consistent user experience.
              </p>
              <p className="mb-4 leading-relaxed">
                We use Vercel Analytics to collect anonymous usage statistics that help us improve the service. This
                data does not contain any personal information.
              </p>

              <h2 className="text-2xl font-semibold mb-4">
                How Invoice Wiki Protects Your Privacy When You Create Invoice
              </h2>
              <p className="mb-4 leading-relaxed">
                At Invoice Wiki, we believe your business information should remain completely private. Our free invoice
                generator is designed with privacy-first principles when you generate invoice:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-6">
                <li>
                  <strong>Local Processing:</strong> All invoice generator data is processed locally in your browser
                  using JavaScript. No information is sent to our servers when you create invoice.
                </li>
                <li>
                  <strong>No Registration Required:</strong> You can start creating invoices immediately without
                  providing any personal information to use our invoice creator.
                </li>
                <li>
                  <strong>No Data Storage:</strong> We don't store your invoice details, client information, or business
                  data on our servers when you generate invoice.
                </li>
                <li>
                  <strong>Secure PDF Generation:</strong> PDF invoice files are created locally in your browser and
                  downloaded directly to your device.
                </li>
                <li>
                  <strong>No Email Required:</strong> Unlike other invoice generators, we never ask for your email
                  address or contact details to create invoice.
                </li>
              </ul>

              <h2 className="text-2xl font-semibold mb-4">What Information We Don't Collect</h2>
              <p className="mb-4 leading-relaxed">
                To be completely transparent, here's what we specifically do NOT collect:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-6">
              ...
              <p className="mb-4 leading-relaxed">
                We use Vercel Analytics to understand how our free invoice generator is being used. This helps us
                improve the service and identify technical issues. The analytics data is completely anonymous and
                includes only:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-6">
              ...
              <p className="mb-4 leading-relaxed">
                Invoice.wiki is hosted on Vercel's secure infrastructure. While we don't send your invoice data to any
                third parties, standard web hosting logs may contain basic technical information like request times and
                general error data. Learn more{" "}
              ...
              <p className="mb-4 leading-relaxed">
                Since we don't collect your personal data, there's nothing for us to delete, modify, or transfer. You
                maintain complete control over your information at all times. If you have concerns about privacy, you
                can:
              </p>
              <ul className="list-disc pl-6 space-y-2 mb-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg my-8">
                ...
                <p className="mb-4 leading-relaxed">
                  Experience the most private way to generate professional invoices online. No registration, no data
                  collection, just fast and secure billing.
                </p>
                <Link
                  href="/create-invoice"
